        ...
        if (guild_db && defaultRole != undefined && jailRole != undefined) {
            if (men_user) {
                if (men_user.is_officer) {
                    yield userschema_1.default.findOneAndUpdate({ user_id: userID }, { is_officer: false });
                    message.reply("**Alrighty" + " " + (men_member === null || men_member === void 0 ? void 0 : men_member.username.toString()) + ", you're fired.**");
                }
                else {
