                ...
                if (author.wanted_lvl < 1 && !(auth === null || auth === void 0 ? void 0 : auth.roles.cache.some((role) => role.id === (guild_db === null || guild_db === void 0 ? void 0 : guild_db.jail_role)))) {
                    if (men_user) {
                        ...
                        if (!(mem === null || mem === void 0 ? void 0 : mem.roles.cache.some((role) => role.id === (guild_db === null || guild_db === void 0 ? void 0 : guild_db.jail_role)))) {
                            message.reply("**Alrighty,**" + " " + (men_member === null || men_member === void 0 ? void 0 : men_member.username.toString()) + " " + "**was sent to jail.**");
                            yield userschema_1.default.findOneAndUpdate({ user_id: userID }, { wanted_level: 0 });
                            mem === null || mem === void 0 ? void 0 : mem.roles.remove(mem.roles.cache);
                            mem === null || mem === void 0 ? void 0 : mem.roles.add(guild_db.jail_role);
                        }
                        else {
