                ...
                if (author.wanted_lvl < 1 && !(auth === null || auth === void 0 ? void 0 : auth.roles.cache.some((role) => role.id === (guild_db === null || guild_db === void 0 ? void 0 : guild_db.jail_role)))) {
                    if (men_user) {
                        if (men_user.wanted_lvl > 0) {
                            yield userschema_1.default.findOneAndUpdate({ user_id: userID }, { wanted_lvl: 0 });
                            yield userschema_1.default.findOneAndUpdate({ user_id: userID }, { wanted_reason: ' ' });
                            message.reply("**Whaa~? Bummer! Ok,**" + " " + (men_member === null || men_member === void 0 ? void 0 : men_member.username.toString()) + " " + "**was cleared of wanted.**");
                        }
                        else {
