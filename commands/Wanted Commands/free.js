...
exports.default = {
    ...
    callback: ({ channel, message, args, guild, member }) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            const currentGuild = index_1.client.guilds.cache.get(guild === null || guild === void 0 ? void 0 : guild.id);
            currentGuild === null || currentGuild === void 0 ? void 0 : currentGuild.members.cache.get(userID);
        }
        catch (_c) {
        ...
        if (guild_db && defaultRole != undefined && jailRole != undefined) {
            if (author.is_officer) {
                if (author.wanted_lvl < 1 && !(auth === null || auth === void 0 ? void 0 : auth.roles.cache.some((role) => role.id === (guild_db === null || guild_db === void 0 ? void 0 : guild_db.jail_role)))) {
                    if (men_user) {
                        if (mem === null || mem === void 0 ? void 0 : mem.roles.cache.some((role) => role.id === (guild_db === null || guild_db === void 0 ? void 0 : guild_db.jail_role))) {
                            message.reply("**Alrighty,**" + " " + (men_member === null || men_member === void 0 ? void 0 : men_member.username.toString()) + " " + "**was released from punishment.**");
                            yield userschema_1.default.findOneAndUpdate({ user_id: userID }, { release_time: 0 });
                            mem === null || mem === void 0 ? void 0 : mem.roles.remove(guild_db.jail_role);
                            mem === null || mem === void 0 ? void 0 : mem.roles.add(guild_db.default_role);
                        }
                        else {
